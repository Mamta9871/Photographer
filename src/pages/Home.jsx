...
import WomanImg from '../img/home/womanh.png'
      ...
      <div className="container mx-auto h-full relative">
        <div className='flex flex-col justify-center'>
          <motion.div 
            ...
            className='w-full pt-36 pb-14 lg:pt-0 lg:pb-36 lg:w-auto
              z-10 lg:absolute flex flex-col justify-center items-center 
              lg:items-center'
          ...
          className='flex justify-end max-h-96 lg:max-h-max'>
            <motion.div 
              ...
              exit={{scale: 0}}
              transition={transition1}
            className='relative lg:-right-32 overflow-hidden'  >
              <motion.img 
