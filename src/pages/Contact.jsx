...
import womanc from "../img/contact/womanc.png";
    ...
    className='section bg-white'>
      ...
      className='container mx-auto h-full'>
        <div className='flex flex-col lg:flex-row h-full items-center justify-start pt-28 gap-x-8 text-center lg:text-left'>
          ...
          className='lg:flex-1 lg:pt-20 px-4'>
            <h1 className='h1 text-[80px]'>Contact me</h1>
            ...
            <form className='flex flex-col gap-y-4'>
              <div className='flex gap-x-10'>
                ...
                placeholder:text-[#757879]' type="text" 
          ...
          className='lg:flex-1 lg:w-3/4'>
            <img className='w-3/4 lg:w-4/5 h-auto mt-10' src={womanc} alt="full image" />
          </motion.div>
        </div>
      </div>
    </motion.section>
